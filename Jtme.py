"""
    APFJogos - Python Text Mode Emulator (port do JTME para Python)
        versao: 2.4 (cursor menor configuravel + leitura de teclado melhorada)
        data: 2026
...
class Jtme(object):
    ...
    #     from Jtme import Jtme
    #     Jtme.cursor_width_factor = 1.0   # cursor cobrindo toda a coluna
    #     Jtme.cursor_height_factor = 0.25 # cursor mais alto
